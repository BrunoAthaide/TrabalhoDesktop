...
public class ProductDetails extends JFrame {
    private JLabel lblId, lblPrice, lblDescription;
    ...
    public void setProductDetails(String id, String price, String description) {
        txtId.setText(id);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                //frame.setProductDetails("123456", "$99.99", "Este é um produto de exemplo.");
